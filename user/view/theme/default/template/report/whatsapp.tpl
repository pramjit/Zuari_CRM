   ...
   <table class="table display" id="example">
        <thead style="background-color:#FF8C00">
          ...
          <tr>
            ...
            <td class="text-center" style="font-weight: bold">WHAT'S APP CALL DATE</td>
...
<script type="text/javascript">
   ...
   if($('#from_date').val().length===0){
     ...
     url='index.php?route=report/whatsapp',
...
function clear_date(){
  ...
  function download(){
    ...
    url = 'index.php?route=report/whatsapp/whatsapp_download',
