       ...
       <tr style="background: #515151; color: #ffffff !important;">
		...
		foreach($advdata as $order){
                ...
                ?>
                    <tr>
                        <td ><?php echo $a; ?></td>
                        <td ><?php echo $order['DATE_RECEIVED'];?></td>
...
<script>
    ...
    {  
       ...
       if($('#from_date').val().length===0){
        ...
        {
         url = 'index.php?route=adminreport/agroreportstatewise',
...
function download()
{
   ...
   var to_date = $('#to_date').val();
       ...
       if($('#from_date').val().length===0){
        ...
        {
            url = 'index.php?route=adminreport/agroreportstatewise/downloadExcel',
            url += '&from_date='+from_date,
            url += '&to_date='+to_date ,
            location = url;
        }
