    ...
    <div class="panel panel-default">
      ...
      <div class="table-responsive" width="100%">
		...
		foreach($head as $order){
                $totalGrand=$order['Crop Nutrition']+$order['Crop Protection']+$order['Seed']+$order['Soil']+$order['Irrigation']+$order['Others'];
                $gtot=$gtot+$order['Crop Nutrition'];
                $totC=$totC+$order['Crop Protection'];
                $totS=$totS+$order['Seed'];
                $totN=$totN+$order['Soil'];
                $totT=$totT+$order['Irrigation'];
                $totA=$totA+$order['Others'];
                
                ?>
                    <tr>
                        <td ><?php echo $a; ?></td>
                        <td ><?php echo $order['STATE_NAME'];?></td>
                        <td ><?php echo $order['ADV_NAME'];?></td>
                        <td ><?php echo $order['Crop Nutrition'];?></td>
                        <td ><?php echo $order['Crop Protection'];?></td>
                        <td ><?php echo $order['Seed'];?></td>
                        <td ><?php echo $order['Soil'];?></td>
                        <td ><?php echo $order['Irrigation'];?></td>
                        <td ><?php echo $order['Others'];?></td>
		...
		<?php
                    $a++;
                        ...
                        <td ><b><?php echo $gtot+$totC+$totS+$totN+$totT+$totA; ?></b></td>
		<?php }
                ?>                      
              </tbody>
            </table>
...
<script type="text/javascript">
  ...
  function clear_state_name()
    ...
    {  
     ...
     }*/else 
     {
           ...
           url='index.php?route=adminreport/headwisesummary',
           url += '&from_date='+from_date,
           url += '&to_date='+to_date ,
  ...
  function download(){
           ...
           url='index.php?route=adminreport/headwisesummary/downloadExcel',
           url += '&from_date='+from_date,
           url += '&to_date='+to_date ,
           url += '&advhead_name='+advhead_name ,
