          ...
          <div class="row">
                ...
                <div class="col-sm-2" form-group required  >
                  <select class="form-control" id="callid" name="callid" onchange="clear_agent_name();">
                      ...
                      <option value="2">RETAILER CALL</option>
                  </select>
                  <p id="agent_name_p" style="display:none;color:red;">Required Agent Name</p>
                </div>
                <div class="col-sm-2 form-group required">
...
function download()
{
   var exid=$('#exid').val();
    ...
    var todt = $('#to_date').val();
            url = 'index.php?route=adminreport/AgentReportCount/downloadExcel',
            url += '&exid='+exid,
            url += '&callid='+callid,
            url += '&frmdt='+frmdt,
            url += '&todt='+todt,
...
function RecordList(){
    ...
    $.ajax({
        type: "POST",
        url: "index.php?route=adminreport/AgentReportCount/RecordList",
