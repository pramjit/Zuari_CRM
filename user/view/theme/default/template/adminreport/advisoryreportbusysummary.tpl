...
<script>
    ...
    {  
       ...
       if($('#from_date').val().length===0){
        ...
        {
         url = 'index.php?route=adminreport/advisoryreportbusysummary',
...
function download()
{
   ...
   var to_date = $('#to_date').val();
       ...
       if($('#from_date').val().length===0){
        ...
        {
            url = 'index.php?route=adminreport/advisoryreportbusysummary/downloadExcel',
            url += '&frmdt='+from_date,
            url += '&todt='+to_date ,
            location = url;
        }
...
function RecordList(){
    ...
    $.ajax({
        type: "POST",
        url: "index.php?route=adminreport/advisoryreportbusysummary/RecordList",
