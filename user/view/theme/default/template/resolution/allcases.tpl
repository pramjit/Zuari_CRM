...
<div   class="panel panel-default">
    <div class="panel-body">
        ...
        <tbody>
            ...
            echo "<td>".$result['FAR_NAME']."</td>";
            echo "<td>".$result['FAR_MOB']."</td>";
            echo "<td>".$result['PROD_CAT']."</td>";
            echo "<td>".$result['CR_DATE']."</td>";
            echo "<td>".$result['DUE_DAYS']."</td>";
            echo "<td>".$result['CASE_STS']."</td>";
...
function showcase(caseid){
    ...
    $.ajax({
    type: "POST",
    url: "index.php?route=resolution/allcases/prodlist",
    data: "caseid="+caseid,
    dataType: "text",
...
function viewhistory(cid){
    //alert('CaseID'+cid);
     $.ajax({
    type: "POST",
    url: "index.php?route=resolution/allcases/history",
    data: "caseid="+cid,
    dataType: "text",
    success: function( data ) {
        //alert(data);
...
function subradata(){
    ...
    var url="index.php?route=resolution/allcases/subradata&ra_case="+ra_case+"&ra_com="+ra_com+"&ra_sts="+ra_sts;
    console.log(data);
    console.log(url);
    $.ajax({
    type: "POST",
