...
function showcase(caseid){
    ...
    $.ajax({
    type: "POST",
    url: "index.php?route=resolution/mycases/prodlist",
    data: "caseid="+caseid,
    dataType: "text",
...
function viewhistory(cid){
    //alert('CaseID'+cid);
     $.ajax({
    type: "POST",
    url: "index.php?route=resolution/mycases/history",
    data: "caseid="+cid,
    dataType: "text",
    success: function( data ) {
        //alert(data);
...
function subradata(){
    ...
    var url="index.php?route=resolution/mycases/subradata&ra_case="+ra_case+"&ra_com="+ra_com+"&ra_sts="+ra_sts;
    console.log(data);
    console.log(url);
    $.ajax({
    type: "POST",
