      ...
      <div class="table-responsive">
            ...
            <td >Pending </td>
              ...
              <tbody>
                <?php if($complain){
                $a='1';
		foreach($complain as $order){
                ?>
                    <tr>
                        <td class="text-left"><?php echo $a; ?></td>
                        <td class="text-left"><?php echo $order['CR_DATE'];?></td>
                        <td class="text-left"><?php echo $order['COMP_MOBILE'];?></td>
                        <td class="text-left"><?php echo $order['STATE'];?></td>
                         <td class="text-left"><?php echo $order['COMPLAINT_QUERY'];?></td> 
                        <td class="text-left"><?php echo $order['COMP_CATG'];?></td>
                        <td class="text-left"><?php echo $order['COMP_TYPE'];?></td>
                        <td class="text-left"><?php echo $order['PROD_GROUP'];?></td>
                        <td class="text-left"><?php echo $order['PROD_CATG'];?></td>
                        <td class="text-left"><?php echo $order['PROD_ID'];?></td>
                        <td class="text-left"><?php echo $order['PROD_BRAND'];?></td>
                         <td class="text-left"><?php echo $order['due_date'];?></td>
...
<script type="text/javascript">
  ...
  function download(){
           ...
           var complain = $('#complain_name').val();
           var pendding = $('#pendding_name').val();
           url='index.php?route=complaint/complaindetails/downloadexcel',
           url += '&from_date='+from_date,
           url += '&to_date='+to_date ,
           url += '&state='+state ,
           url += '&complain='+complain ,
