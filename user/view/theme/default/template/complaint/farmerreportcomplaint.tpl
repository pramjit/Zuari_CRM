      ...
      <div class="table-responsive">
		...
		foreach($complain as $order){
                    ...
                    <tr>
                        ...
                        <td class="text-left"><?php echo $order['Totalcalls'];?></td>
                          <th>
                           <table >
                               <tr>
                                   <td  style="padding-right:150px;"><?php echo $order['totalcomplaint'];?></td>
                                   <td  style="padding-right:100px;"><?php echo $order['totalcompending'];?></td>
                                   <td  style="padding-right:0px;"><?php echo $order['totalcomplaintclose'];?></td>
                               </tr>
                            </table>
                         </th>
                           <th>
                           <table >
                               <tr>
                                   <td  style="padding-right:150px;"><?php echo $order['totalothercall'];?></td>
                                   <td  style="padding-right:80px;"><?php echo $order['totalotherpending'];?></td>
                                   <td  style="padding-right:0px;"><?php echo $order['totalothercallclose'];?></td>
                               </tr>
                            </table>
                         </th>
...
<script type="text/javascript">
  ...
  function download(){
           ...
           var complain = $('#complain_name').val();
           var pendding = $('#pendding_name').val();
           url='index.php?route=complaint/farmerreportcomplaint/downloadexcel',
           url += '&from_date='+from_date,
           url += '&to_date='+to_date ,
           url += '&state='+state ,
           url += '&complain='+complain ,
