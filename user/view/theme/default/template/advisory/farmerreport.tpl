  ...
  <div class="container-fluid">
    ...
    <!--<div class="panel panel-default">
      ...
      <div class="table-responsive">
            ...
            <td >MOBILE NO.</td>
            <td >TOTAL CALLS</td>
             <td >TOTAL PENDING CALL ADVISORY</td>
             <td >PENDING CALL CALL CENTER</td>
              <td >PENDING CALL ADVISORY APPROVAL</td>
              <td >CLOSE CALL</td>
		...
		foreach($complain as $order){
                    ...
                    <tr>
                        ...
                        <td class="text-left"><?php echo $order['Totalcallsadviory'];?></td>
                        <td class="text-left"><?php echo $order['AdvisoryPendingCC'];?></td>
                        <td class="text-left"><?php echo $order['AprovalPendingCAlls'];?></td>
                         <td class="text-left"><?php echo $order['close'];?></td>
