...
<div class="hide-all">
        ...
        <div class="col-sm-8">
                ...
                <div class="col-md-12"  style="font-size: 18px;font-weight: bold;color: #337ab7;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;&nbsp;Advisory form </div>
    ...
    <form id="clfrm" name="clfrm">           
                ...
                <div class="col-md-4">
                    <input type="button" id="regcom" name="regcom" class="btn btn-primary" value="Submit Data" onclick="SaveFeedback();" style="    padding: 6px 52px !important; font-size: 18px;" disabled="disabled">
                </div>
            </form>
        </div>
        </div> <!-- Hide All end -->
