    ...
    <div class="panel-body">
        ...
        <thead>
            <tr role="row" style="background: #12a4f4; color: #ffffff;">
                ...
                <th>MOBILE</th>
                <th>CREATE DATE</th>
                <th>CALLING AGENT NOTE</th>
                <th>EDIT AND APPROVE</th>
                <th>APPROVE</th>
        ...
        <tbody>
            ...
            echo "<td>".$result['CASE_FAR']."</td>";
            echo "<td>".$result['CASE_MOB']."</td>";
            echo "<td>".$result['CASE_DATE']."</td>";
            echo "<td>".$result['CASE_QRY']."</td>";
            echo "<td style='font-size:24px; padding:0px' onclick='showcase(".$result['CASE_ID'].");' class='btn-warning text-center'>";
            echo "<i class='fa fa-pencil-square-o' aria-hidden='true'>&nbsp;</i><i class='fa fa-check-square-o' aria-hidden='true'></i>";
            echo "</td>";
            echo "<td style='font-size:24px; padding:0px' onclick='approve(".$result['CASE_ID'].");' class='btn-success text-center'>";
            echo "<i class='fa fa-check-square-o' aria-hidden='true'></i>";
            echo "</td>";
            echo "<td style='font-size:24px; padding:0px' class='btn-default'><i class='fa fa-volume-up' aria-hidden='true'></i></td>";
            echo "</tr>";
            $n++;
            }
           ?>
