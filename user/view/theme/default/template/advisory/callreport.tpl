  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
       ...
       <div class="panel-body">
        <div class="well">
         <div class="row">
            ...
            <input class="form-control input-date" data-date-format="YYYY-MM-DD" type="text" id="from_date" onchange="clear_from_date()" name="from_date"  placeholder="From Date" value="<?php echo $from_date; ?>"/> 
            <p id="from_date_p" style="display:none;color:red;">Required From Date</p> 

            </div>
            <div class="col-sm-4 form-group required">
              <input class="form-control input-date" type="text"  data-date-format="YYYY-MM-DD" id="to_date" onchange="clear_to_date()" name="to_date"  placeholder="To Date" value="<?php echo $to_date; ?>"/>
                <p id="to_date_p" style="display:none;color:red;">Required To Date</p>
            </div>
      ...
      <div class="table-responsive">
          <table class="table display" id="example" style="font-size: 11px;">
            <thead>
              ...
              <tbody>
                ...
                foreach($orders as $order){
                    ...
                    <tr>
                        ...
                        <td class="text-left"><?php if($order['CALL_STATUS']=='Agro Advisory'){echo 'RESUBMIT TO ADVISORY';}else{echo $order['CALL_STATUS'];}?></td>
                        ...
                        <td class="text-left"><?php echo $order['CASE_STATUS'];?></td>  
                        <td class="text-left"><?php echo $order['CALL_COUNT'];?></td> 
                        <td class="text-left"><?php if($order['LAST_STATUS']=='Missed Call'){echo 'NOT ATTEMPT';}else{echo $order['LAST_STATUS'];}?></td> 
                    </tr>			
		<?php
                    $a++;
                    }
...
<link rel="stylesheet" type="text/css" value="<?php echo $lasttodate; ?>"href="https://cdn.datatables.net/1.10.15/css/jquery.dataTables.min.css">
    ...
    {  
      if($('#from_date').val().length===0){
        ...
        $('#to_date_p').show();
           ...
           url='index.php?route=advisory/callreport',
