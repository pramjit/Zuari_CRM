...
function showform(mob){
    $.ajax({
    type: "POST",
    url: "index.php?route=call/review/retrivedata",
    data: "mob="+mob,
    dataType: "text",
...
function showdist(stid){
  //alert(stid);
    ...
    $.ajax({
    type: "POST",
    url: "index.php?route=call/review/distlist",
    data: "stsid="+stid,
    dataType: "text",
    success: function( data ) {
...
function eshowdist(stid){
  //alert(stid);
    ...
    $.ajax({
    type: "POST",
    url: "index.php?route=call/review/edistlist",
    data: "stsid="+stid,
    dataType: "text",
    success: function( data ) {
...
function dshowdist(stid){
  //alert(stid);
    ...
    $.ajax({
    type: "POST",
    url: "index.php?route=call/review/ddistlist",
    data: "stsid="+stid,
    dataType: "text",
    success: function( data ) {
...
function showpro(catid){
    $.ajax({
    type: "POST",
    url: "index.php?route=call/review/prodlist",
    data: "catid="+catid,
    dataType: "text",
    success: function( data ) {
...
function eshowpro(catid){
    $.ajax({
    type: "POST",
    url: "index.php?route=call/review/eprodlist",
    data: "catid="+catid,
    dataType: "text",
    success: function( data ) {
...
function showcomp(comid){
  //alert(stid);
    ...
    $.ajax({
    type: "POST",
    url: "index.php?route=call/review/complist",
    data: "comid="+comid,
    dataType: "text",
    success: function( data ) {
...
<script type="text/javascript">
  ...
  function subreviewdata(){
      ...
      var url="index.php?route=call/review/savereview";
      console.log(url);
  ...
  function subenqdata(){
      ...
      var serlizedata = $("#clfrm").serialize();
      console.log(serlizedata);
        var url="index.php?route=call/review/saveform";
        console.log(url);
        $.post(url, serlizedata, function (data) {
            console.log(data);
        });
