...
//********************** SUBMIT ADV APPROVE DATA **********************//
    ...
    public function advrecord(){
            ...
            if(is_dir($basepath)){
                if($dh = opendir($basepath)){
                        while(($file= readdir($dh))!== FALSE){
                            ...
                            if(($file!=='.') && ($file!=='..') && (substr($file,0,4)==$case_pin) && (substr($file,5,10)==$from_mob) && (substr($file,36,10)==$to_mob)){
     ...
     foreach($CaseData as $data){
		...
		$cn.='</div>';
		$cn.='<div class="col-md-3">';
		$cn.='<input type="text" class="form-control" name="crop_Details_Nurtition" id="crop_Details_Nurtition" value="'.$data['CROP_DETAILS'].'" readonly="readonly">';
        $cn.='</div>';
        $cn.='<div class="col-md-6">';
        $cn.='<textarea style="min-height:75px!important;" class="form-control" id="Crop_Nutrition_Data"  name="Crop_Nutrition_Data" placeholder="Crop Nutrition Complaint details...">'.$data['ADV_HEAD_DETAILS'].'</textarea>';
        $cn.='</div>';
        }
        ...
        $cp.='</div>';
		$cp.='<div class="col-md-3">';
		$cp.='<input type="text" class="form-control" name="crop_Details_Protection" id="crop_Details_Protection" value="'.$data['CROP_DETAILS'].'" readonly="readonly">';
        $cp.='</div>';
        $cp.='<div class="col-md-6">';
        $cp.='<textarea style="min-height:75px!important;" class="form-control" id="Crop_Protection_Data" name="Crop_Protection_Data" placeholder="Crop Protection Complaint details...">'.$data['ADV_HEAD_DETAILS'].'</textarea>';
        $cp.='</div>';
        }
        ...
        $cd.='</div>';
		$cd.='<div class="col-md-3">';
		$cd.='<input type="text" class="form-control" name="crop_Details_Seed" id="crop_Details_Seed" value="'.$data['CROP_DETAILS'].'" readonly="readonly">';
        $cd.='</div>';
        $cd.='<div class="col-md-6">';
        $cd.='<textarea style="min-height:75px!important;" class="form-control" id="Seed_Data" name="Seed_Data" placeholder="Seed Complaint details...">'.$data['ADV_HEAD_DETAILS'].'</textarea>';
        $cd.='</div>';
        }
        ...
        $sl.='</div>';
		$sl.='<div class="col-md-3">';
		$sl.='<input type="text" class="form-control" name="crop_Details_Soil" id="crop_Details_Soil" value="'.$data['CROP_DETAILS'].'" readonly="readonly">';
        $sl.='</div>';
        $sl.='<div class="col-md-6">';
        $sl.='<textarea style="min-height:75px!important;" class="form-control" id="Soil_Data" name="Soil_Data" placeholder="Soil Complaint details...">'.$data['ADV_HEAD_DETAILS'].'</textarea>';
        $sl.='</div>';
        }
        ...
        $ir.='</div>';
		$ir.='<div class="col-md-3">';
		$ir.='<input type="text" class="form-control" name="crop_Details_Irrigation" id="crop_Details_Irrigation" value="'.$data['CROP_DETAILS'].'" readonly="readonly">';
        $ir.='</div>';
        $ir.='<div class="col-md-6">';
        $ir.='<textarea style="min-height:75px!important;" class="form-control" id="Irrigation_Data" name="Irrigation_Data" placeholder="Irrigation Complaint details...">'.$data['ADV_HEAD_DETAILS'].'</textarea>';
        $ir.='</div>';
        }
        ...
        $ot.='</div>';
		$ot.='<div class="col-md-3">';
		$ot.='<input type="text" class="form-control" name="crop_Details_Others" id="crop_Details_Others" value="'.$data['CROP_DETAILS'].'" readonly="readonly">';
        $ot.='</div>';
        $ot.='<div class="col-md-6">';
        $ot.='<textarea style="min-height:75px!important;" class="form-control" id="Others_Data" name="Others_Data" placeholder="Others Complaint details...">'.$data['ADV_HEAD_DETAILS'].'</textarea>';
        $ot.='</div>';
        }
        ...
        $cn.='</div>';
		$cn.='<div class="col-md-3">';
		$cn.='<input type="text" class="form-control" name="crop_Details_Nurtition" id="crop_Details_Nurtition" value="NA" readonly="readonly">';
        $cn.='</div>';
        $cn.='<div class="col-md-6">';
        $cn.='<textarea style="min-height:75px!important;" class="form-control" id="Crop_Nutrition_Data" name="Crop_Nutrition_Data" placeholder="Crop Nutrition Complaint details..."></textarea>';
        $cn.='</div>';
        }
        if($cp==''){
        $cp.='<div class="col-md-3">';
        ...
        $cp.='</div>';
		$cp.='<div class="col-md-3">';
		$cp.='<input type="text" class="form-control" name="crop_Details_Protection" id="crop_Details_Protection" value="NA" readonly="readonly">';
        $cp.='</div>';
        $cp.='<div class="col-md-6">';
        $cp.='<textarea style="min-height:75px!important;" class="form-control" id="Crop_Protection_Data" name="Crop_Protection_Data" placeholder="Crop Protection Complaint details..."></textarea>';
        $cp.='</div>';    
        }
        if($cd==''){
        $cd.='<div class="col-md-3">';
        ...
        $cd.='</div>';
		$cd.='<div class="col-md-3">';
		$cd.='<input type="text" class="form-control" name="crop_Details_Seed" id="crop_Details_Seed" value="NA" readonly="readonly">';
        $cd.='</div>';
        $cd.='<div class="col-md-6">';
        $cd.='<textarea style="min-height:75px!important;" class="form-control" id="Seed_Data" name="Seed_Data" placeholder="Seed Complaint details..."></textarea>';
        $cd.='</div>';    
        }
        if($sl==''){
        $sl.='<div class="col-md-3">';
        ...
        $sl.='</div>';
		$sl.='<div class="col-md-3">';
		$sl.='<input type="text" class="form-control" name="crop_Details_Soil" id="crop_Details_Soil" value="NA" readonly="readonly">';
        $sl.='</div>';
        $sl.='<div class="col-md-6">';
        $sl.='<textarea style="min-height:75px!important;" class="form-control" id="Soil_Data" name="Soil_Data" placeholder="Soil Complaint details..."></textarea>';
        $sl.='</div>';    
        }
        if($ir==''){
        $ir.='<div class="col-md-3">';
        ...
        $ir.='</div>';
		$ir.='<div class="col-md-3">';
		$ir.='<input type="text" class="form-control" name="crop_Details_Irrigation" id="crop_Details_Irrigation" value="NA" readonly="readonly">';
        $ir.='</div>';
        $ir.='<div class="col-md-6">';
        $ir.='<textarea style="min-height:75px!important;" class="form-control" id="Irrigation_Data" name="Irrigation_Data" placeholder="Irrigation Complaint details..."></textarea>';
        $ir.='</div>';   
        }
        if($ot==''){
        $ot.='<div class="col-md-3">';
        ...
        $ot.='</div>';
		$ot.='<div class="col-md-3">';
		$ot.='<input type="text" class="form-control" name="crop_Details_Others" id="crop_Details_Others" value="NA" readonly="readonly">';
        $ot.='</div>';
        $ot.='<div class="col-md-6">';
        $ot.='<textarea style="min-height:75px!important;" class="form-control" id="Others_Data" name="Others_Data" placeholder="Others Complaint details..."></textarea>';
        $ot.='</div>';    
        }
