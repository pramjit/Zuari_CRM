<?php
class Controlleradvisorydashboard extends Controller {
public function  index(){
//$this->load->language('advisory/dashboard');
$this->document->setTitle($this->language->get('heading_title'));      
$this->load->model('advisory/dashboard');
...
$data['lnk'] = $this->url->link('advisory/dashboard','token=' . $this->session->data['token'], 'SSL');
$data['orders'] = array();
...
$data['callData']= $this->model_advisory_dashboard->TotalcallData();
$order_total_count = $this->model_advisory_dashboard->getmissedcallDatacount($this->request->get);
$order_total = count($order_total_count);

$data['StateData']= $this->model_advisory_dashboard->StateData();
$data['CropData']= $this->model_advisory_dashboard->CropData();
$data['CallSts']= $this->model_advisory_dashboard->CallSts();
$data['CallUsr']= $this->model_advisory_dashboard->CallUsr();
$data['ProdCatData']= $this->model_advisory_dashboard->ProdCatData();
$data['CompCatData']= $this->model_advisory_dashboard->CompCatData();
$data['EnqCatData']= $this->model_advisory_dashboard->EnqCatData();
$data['EnqTypData']= $this->model_advisory_dashboard->EnqTypData();
...
$pagination->url = $this->url->link('advisory/dashboard', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
...
$data['order_statuses'] = "";
$this->session->data["title"]='ADVISORY - DASHBOARD';
$data['sort'] = $sort;
$data['order'] = $order;
...
$data['breadcrumbs'][] = array(
'text' => 'Dashboard',
'href' => $this->url->link('advisory/dashboard')
);
...
$this->response->setOutput($this->load->view('default/template/advisory/dashboard.tpl', $data));
...
public function distlist(){
   ...
   // $a = $this->request->post['stsid'];
    $DistData= $this->model_advisory_dashboard->DistData($this->request->post['stsid']);
    //print_r( $DistData);
...
public function prodlist(){
   ...
   // $a = $this->request->post['stsid'];
    ...
    $ProdData= $this->model_advisory_dashboard->ProdData($this->request->post['catid']);
    //print_r( $DistData);
...
public function complist(){
    $this->load->model('advisory/dashboard');
   // $a = $this->request->post['stsid'];
    $CompData= $this->model_advisory_dashboard->CompData($this->request->post['comid']);
    //print_r( $DistData);
