<?php
class Controllerresolutionallcases extends Controller {
public function  index(){
//$this->load->language('resolution/allcases');
$this->document->setTitle($this->language->get('heading_title'));      
$this->load->model('resolution/allcases');
...
$data['lnk'] = $this->url->link('resolution/allcases','token=' . $this->session->data['token'], 'SSL');
$data['orders'] = array();
...
$data['MyCaseData']= $this->model_resolution_allcases->getmissedcallData($this->request->get);
$order_total_count = $this->model_resolution_allcases->getmissedcallDatacount($this->request->get);
$order_total = count($order_total_count);

$data['StateData']= $this->model_resolution_allcases->StateData();
$data['CropData']= $this->model_resolution_allcases->CropData();
$data['CallSts']= $this->model_resolution_allcases->CallSts();
$data['CallUsr']= $this->model_resolution_allcases->CallUsr();
$data['ProdCatData']= $this->model_resolution_allcases->ProdCatData();
$data['CompCatData']= $this->model_resolution_allcases->CompCatData();
$data['EnqCatData']= $this->model_resolution_allcases->EnqCatData();
$data['EnqTypData']= $this->model_resolution_allcases->EnqTypData();
...
$pagination->url = $this->url->link('resolution/allcases', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
...
$data['order_statuses'] = "";
$this->session->data["title"]='Resolution Authority - All Cases';
$data['sort'] = $sort;
$data['order'] = $order;
...
$data['breadcrumbs'][] = array(
'text' => 'All Cases',
'href' => $this->url->link('resolution/allcases')
);
...
$this->response->setOutput($this->load->view('default/template/resolution/allcases.tpl', $data));
...
public function distlist(){
   ...
   // $a = $this->request->post['stsid'];
    $DistData= $this->model_resolution_allcases->DistData($this->request->post['stsid']);
    //print_r( $DistData);
...
public function prodlist(){
    $this->load->model('resolution/allcases');
   // $a = $this->request->post['stsid'];
    $RaStatus= $this->model_resolution_allcases->RaStatus();
    $ProdData= $this->model_resolution_allcases->ProdData($this->request->post['caseid']);
    ...
    //print_r( $DistData); 
        ...
        foreach($ProdData as $prod){
            ...
            if(empty($cur_usr))
            {
                ...
                $cur_usr= $this->model_resolution_allcases->CaseCurUser($this->customer->getId());
            }
            echo '<tr>';
   ...
   // $a = $this->request->post['stsid'];
    ...
    $HisData= $this->model_resolution_allcases->History($this->request->post['caseid']);
    ...
    public function subradata(){
        ...
        $RaSubData= $this->model_resolution_allcases->subradata($caseid,$commnts,$status,$filepath);
        if($RaSubData==1)
        {
