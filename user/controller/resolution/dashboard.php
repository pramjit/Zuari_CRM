<?php
class Controllerresolutiondashboard extends Controller {
public function  index(){
//$this->load->language('resolution/dashboard');
$this->document->setTitle($this->language->get('heading_title'));      
$this->load->model('resolution/dashboard');
...
$data['lnk'] = $this->url->link('resolution/dashboard','token=' . $this->session->data['token'], 'SSL');
$data['orders'] = array();
...
$data['callData']= $this->model_resolution_dashboard->TotalcallData();
$data['catData']= $this->model_resolution_dashboard->TotalcatData();
$order_total_count = $this->model_resolution_dashboard->getmissedcallDatacount($this->request->get);
$order_total = count($order_total_count);

$data['StateData']= $this->model_resolution_dashboard->StateData();
$data['CropData']= $this->model_resolution_dashboard->CropData();
$data['CallSts']= $this->model_resolution_dashboard->CallSts();
$data['CallUsr']= $this->model_resolution_dashboard->CallUsr();
$data['ProdCatData']= $this->model_resolution_dashboard->ProdCatData();
$data['CompCatData']= $this->model_resolution_dashboard->CompCatData();
$data['EnqCatData']= $this->model_resolution_dashboard->EnqCatData();
$data['EnqTypData']= $this->model_resolution_dashboard->EnqTypData();
...
$pagination->url = $this->url->link('resolution/dashboard', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
...
$data['order_statuses'] = "";
$this->session->data["title"]='RA - DASHBOARD';
$data['sort'] = $sort;
$data['order'] = $order;
...
$data['breadcrumbs'][] = array(
'text' => 'Dashboard',
'href' => $this->url->link('resolution/dashboard')
);
...
$this->response->setOutput($this->load->view('default/template/resolution/dashboard.tpl', $data));
...
public function distlist(){
   ...
   // $a = $this->request->post['stsid'];
    $DistData= $this->model_resolution_dashboard->DistData($this->request->post['stsid']);
    //print_r( $DistData);
...
public function prodlist(){
   ...
   // $a = $this->request->post['stsid'];
    ...
    $ProdData= $this->model_resolution_dashboard->ProdData($this->request->post['catid']);
    //print_r( $DistData);
...
public function complist(){
    $this->load->model('resolution/dashboard');
   // $a = $this->request->post['stsid'];
    $CompData= $this->model_resolution_dashboard->CompData($this->request->post['comid']);
    //print_r( $DistData);
