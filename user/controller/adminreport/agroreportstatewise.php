<?php
class Controlleradminreportagroreportstatewise extends Controller 
{
...
'href' => $this->url->link('callreport/agentwisereport')
);
$this->load->model('adminreport/agroreportstatewise');
$data['advdata']= $this->model_adminreport_agroreportstatewise->agroAdvisory($this->request->get);
...
$this->response->setOutput($this->load->view('default/template/adminreport/agroreportstatewise.tpl', $data));
...
$this->load->model('adminreport/agroreportstatewise');
$advdata= $this->model_adminreport_agroreportstatewise->agroAdvisory($this->request->get); 
$row = 2;
$col = 1;
$tp='';
