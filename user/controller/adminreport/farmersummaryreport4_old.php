...
{       $totOrder=$data['FARMER NOT RESPONDING']+$data['FARMER NOT RESPONDING']+$data['CLOSED']+$data['PENDING APPROVAL']+$data['PENDING ADVISORY']+$data['PENDING CC'];
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(2, $row,$data['FARMER NOT RESPONDING']);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3, $row, $data['CLOSED']);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, $row, $data['PENDING APPROVAL']);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, $row, $data['PENDING ADVISORY']);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6, $row, $data['PENDING CC']);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7, $row, $totOrder);
