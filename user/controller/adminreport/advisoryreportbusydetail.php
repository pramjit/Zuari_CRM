<?php
class Controlleradminreportadvisoryreportbusydetail extends Controller 
{
...
'href' => $this->url->link('adminreport/advisoryreportbusydetail')
);
$this->load->model('adminreport/advisoryreportbusydetail');
$data['farmerdata']= $this->model_adminreport_advisoryreportbusydetail->farmerdetail($this->request->get);
...
$this->response->setOutput($this->load->view('default/template/adminreport/advisoryreportbusydetail.tpl', $data));
...
$this->load->model('adminreport/advisoryreportbusydetail');
$farmerdata= $this->model_adminreport_advisoryreportbusydetail->farmerdetail($this->request->get);
$row = 2;
$col = 1;
$tp='';
