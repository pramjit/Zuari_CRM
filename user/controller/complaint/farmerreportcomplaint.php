<?php
class Controllercomplaintfarmerreportcomplaint extends Controller {
...
$this->session->data["title"]='Farmer Report';
$data['breadcrumbs'][] = array(
'text' => 'Farmer Report',
'href' => $this->url->link('complaint/farmerreportcomplaint')
);
$this->load->model('complaint/farmerreportcomplaint');

$data['complain']= $this->model_complaint_farmerreportcomplaint->getfarmerdata($this->request->get);
//get State

$this->response->setOutput($this->load->view('default/template/complaint/farmerreportcomplaint.tpl', $data));
...
'Total Complaint Pending Calls',
'Total Complaint Close Calls',
'Total Other Calls',
'Total Other Pending Calls',
'Total Other Close Calls'   
...
$this->load->model('complaint/farmerreportcomplaint');
$results= $this->model_complaint_farmerreportcomplaint->getfarmerdata($this->request->get);
//print_r($results);die;
$status='';
$statusp='';
