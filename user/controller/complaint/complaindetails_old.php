...
foreach($results as $data)
{
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(11, $row, $data['case_status']);
        ...
        $objPHPExcel->getActiveSheet()->getStyle('A1:M1')->getFont()->setItalic(true);
        $objPHPExcel->getActiveSheet()->getStyle('A1:M1')->getFont()->setBold(true);
        $objPHPExcel->getActiveSheet()->getStyle('A1:M1')->getFont()->setSize(12);
        $objPHPExcel->getActiveSheet()->getDefaultRowDimension('A1:M1')->setRowHeight(20);
        $objPHPExcel->getActiveSheet()->getStyle('A1:M1')->getFont()->getColor()->setRGB('000DEF');
$col++;
$row++;
}
