...
//*****************************MAIL FUNCTION END***********************************************//
   ...
   // print_r($data);die;
    ...
    for($i=0;$i<$len;$i++){
        ...
        $reportData= $this->model_report_dailyadvisoryreport->adv_list_data($data1[$i]['customer_id']);
         //print_r($reportData);
        ...
        if($reportData){
            ...
            foreach($reportData as $data){
                ...
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $row, $data['CR_DATE']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(1, $row, $data['FAR_MOB']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(2, $row, $data['CASE_PIN']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3, $row, $data['CASE_STATUS']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, $row, $data['CALL_STATUS']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, $row, $data['CALL_COUNT']);
