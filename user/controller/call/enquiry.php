<?php
class Controllercallmissedcall extends Controller {
...
$data['order_statuses'] = "";
$this->session->data["title"]='Missed Call Data';
$data['sort'] = $sort;
$data['order'] = $order;
...
$data['breadcrumbs'][] = array(
'text' => 'Missed Call',
'href' => $this->url->link('call/missedcall')
);
...
$this->response->setOutput($this->load->view('default/template/call/missedcall.tpl', $data));
...
$this->load->model('call/missedcall');
$results =$this->model_call_missedcall->getmissedcallData($this->request->get);
$row = 2;
$col = 1;
...
header('Content-Disposition: attachment;filename="Missed_Call_Call'.date('dMy').'.xls"');
