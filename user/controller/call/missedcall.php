...
public function distlist(){
   ...
   // $a = $this->request->post['stsid'];
    $DistData= $this->model_call_missedcall->DistData($this->request->post['stsid']);
    //print_r( $DistData);
...
public function prodlist(){
   ...
   // $a = $this->request->post['stsid'];
    ...
    $ProdData= $this->model_call_missedcall->ProdData($this->request->post['catid']);
    //print_r( $DistData);
...
public function complist(){
    $this->load->model('call/missedcall');
   // $a = $this->request->post['stsid'];
    $CompData= $this->model_call_missedcall->CompData($this->request->post['comid']);
    //print_r( $DistData);
    ...
    public function saveform(){
        $this->load->model('call/missedcall');
        $SaveData= $this->model_call_missedcall->SaveFormData($this->request->post);
        if($SaveData==2){
            echo 'Enquiry';
        }
        else if($SaveData==1){
