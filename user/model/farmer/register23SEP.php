        ...
        if($calsts==2 && $empsts==2){
            ...
            if($query->row['DEL_MOB']){
                ...
                $insql="UPDATE `ak_dealer` SET
                    ...
                    `EMP_STATUS`='".$empsts."',
                    `CR_DATE` ='".$cr_datetime."',
                    `CR_BY` ='".$cr_by."',`DEL_CODE`='".$ApiFarmerCode."', `DEL_LIVE`= '".$ApiFarmerLive."',`DEL_TYPE`='".$ApiFarmerType."' WHERE `DEL_MOB` ='".$delmob."'";
            }
            else{
                ...
                $insql="INSERT INTO `ak_dealer` SET
                    ...
                    `EMP_STATUS`='".$empsts."',
                    `CR_DATE` ='".$cr_datetime."',
                    `CR_BY` ='".$cr_by."',`DEL_CODE`='".$ApiFarmerCode."', `DEL_LIVE`= '".$ApiFarmerLive."',`DEL_TYPE`='".$ApiFarmerType."'";
            }
