...
class ModelAccountCustomer extends Model {
	...
	public function editPasswordforget($email, $password) {
		

		$this->db->query("UPDATE " . DB_PREFIX . "customer SET salt = '" . $this->db->escape($salt = substr(md5(uniqid(rand(), true)), 0, 9)) . "', password = '" . $this->db->escape(sha1($salt . sha1($salt . sha1($password)))) . "' WHERE LOWER(User_Id) = '" . $this->db->escape(utf8_strtolower($email)) . "'");
...
public function getCustomerByUserId($email) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "customer WHERE LOWER(User_Id) = '" . $this->db->escape(utf8_strtolower($email)) . "'");
	...
	public function deleteLoginAttempts($email) {
        ...
        public function checkmobile($email) {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "customer` WHERE User_Id = '" . $this->db->escape(utf8_strtolower($email)) . "' and customer_group_id IN(64,65,67,68)");
