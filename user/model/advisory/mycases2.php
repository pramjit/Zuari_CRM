...
class Modeladvisorymycases extends Model {
    ...
    public function getmissedcallData($data){
            ...
            from crm_adv cra
            LEFT JOIN crm_farmer crf ON(cra.FAR_MOB = crf.FAR_MOBILE)
            LEFT JOIN crm_case_status ccs ON(cra.CASE_STATUS = ccs.sid) where cra.case_status=7";
