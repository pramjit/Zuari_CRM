...
$log->write($sql);                                                                             
    ...
    public function CallSts(){
        $sql="select STATUS_ID,STATUS_NAME from mas_callstatus where ACT=1 and STATUS_ID NOT IN(2,5,29,30,31,32,33,34)";
        $query = $this->db->query($sql);
        return $query->rows;   
    }
    ...
    public function SaveFeedBack($data){
        ...
        if($suc1==1 || $suc2==1 || $suc3==1 || $suc4==1 || $suc5==1 || $suc6==1){
            ...
            $upadv="update crm_adv set case_status='".$callsts."', tot_attempt=tot_attempt+1 where case_id='".$caseid."'";
