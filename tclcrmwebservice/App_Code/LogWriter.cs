...
public class LogWriter
    {
        ...
        private static string logDir = @"C:\inetpub\wwwroot\zuari\tclcrmwebservice\ERROR\";
        private static string logFile ="log"; //<Your Log File Name or Config Setting>;
        private static int maxLogAge = int.Parse("3600");
