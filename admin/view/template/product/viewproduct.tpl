              ...
              <tbody>
               ...
               <?php 
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $resultt['PRODUCT_NAME']; ?></td>
                  <td class="text-left"><?php echo $resultt['SKU']; ?></td>
                  <td class="text-left"><?php echo  $resultt['UNIT']; ?></td>
           <td class="text-left"><img src="http://192.168.1.159/aksha/system/upload/<?php echo $resultt['PRODUCT_IMAGE']; ?>" style="height: 59px !important;
width: 60px !important;"></img></td>
                  <td class="text-left"><a onclick="updateretailerreg(<?php echo $resultt['SID'] ?>);" style="color:rgb(102, 32, 62);cursor: pointer;" >Edit</a></td>
...
function updateretailerreg(sid){
    url = 'index.php?route=product/addproduct&customeridupdate='+sid+'&token='+getURLVar('token');
    location = url;
}
// download
