...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <h1><?php echo 'Farmer View' ?></h1>
      <ul class="breadcrumb">
        <?php foreach ($breadcrumbs as $breadcrumb) { ?>
        <li><a href="<?php echo $breadcrumb['href']; ?>">view Farmer</a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
...
function updateretailerreg(customerid){
    url = 'index.php?route=farmer/farmerupdate&customeridupdate='+customerid+'&token='+getURLVar('token');
    location = url;
}
// download
...
function backbtn(){
    url = 'index.php?route=farmer/viewfarmer&token='+getURLVar('token');
    location = url;
}
