             ...
             <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'o.order_id') { ?>
                    <a><?php echo $column_milkcenter_person; ?></a>
                    <?php } else { ?>
                    <a><?php echo $column_milkcenter_person; ?></a>
                    <?php } ?></td>
                   ...
                   <td class="text-right"><?php if ($sort == 'o.order_id') { ?>
                    <a><?php echo $column_contact; ?></a>
                    <?php } else { ?>
                    <a><?php echo $column_contact; ?></a>
                    <?php } ?></td>
                   
                    <td class="text-right"><?php if ($sort == 'o.order_id') { ?>
                    <a><?php echo $daily_collection; ?></a>
                    <?php } else { ?>
                    <a><?php echo $daily_collection; ?></a>
                    <?php } ?></td>
                    
                     <td class="text-right"><?php if ($sort == 'o.order_id') { ?>
                    <a><?php echo $daily_cow_collection; ?></a>
                    <?php } else { ?>
                    <a><?php echo $daily_cow_collection; ?></a>
                    <?php } ?></td>
                     
                      <td class="text-right"><?php if ($sort == 'o.order_id') { ?>
                    <a><?php echo $daily_buffalo_collection; ?></a>
                    <?php } else { ?>
                    <a><?php echo $daily_buffalo_collection; ?></a>
                    <?php } ?></td>
                       <td class="text-right"><?php if ($sort == 'o.order_id') { ?>
                    <a><?php echo $farmer_connected; ?></a>
                    <?php } else { ?>
                    <a><?php echo $farmer_connected; ?></a>
                    <?php } ?></td>
                        <td class="text-right"><?php if ($sort == 'o.order_id') { ?>
                    <a><?php echo $current_feed; ?></a>
                    <?php } else { ?>
                    <a><?php echo $current_feed; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $geos['Dates']; ?></td>
                   <td class="text-left"><?php echo $geos['MLK_CENTER_PERSON']; ?></td>
                    <td class="text-left"><?php echo $geos['CONTACT_NUMBER']; ?></td>
                  <td class="text-right"><?php echo $geos['MILK_DAILY_COLLECTION']; ?></td>
                   <td class="text-right"><?php echo $geos['Daily_cow_collection']; ?></td>
                   
                   <td class="text-left"><?php echo $geos['Daily_baffalo_collection']; ?></td>
                  <td class="text-right"><?php echo $geos['NO_OF_FARMERS']; ?></td>
                   <td class="text-right"><?php echo $geos['CURRENT_FEED_COMPANY']; ?></td>
...
<script type="text/javascript">
 ...
 $('#searchbtn').on('click', function() {
    ...
    url = 'index.php?route=Report/milkcollcdailyreport&token='+getURLVar('token');
...
$('#downloadattendance').on('click', function() {
   ...
   url = 'index.php?route=Report/milkcollcdailyreport/marketpos_download&token='+getURLVar('token');
    var filter_fdate_id = $('input[name=\'from_date\']').val();
    var filter_tdate_id = $('input[name=\'to_date\']').val();
    var filter_market_pos = $('#market_pos').val();
...
function CheckIsCharacter(e,t){
       ...
       function getmdo(state_id){
        ...
        $.ajax({ 
        type: 'post',
        url: 'index.php?route=Report/milkcollcdailyreport/getmdo&token='+getURLVar('token'),
        data: 'state='+state_id,
        // dataType: 'json',
        cache: false,
