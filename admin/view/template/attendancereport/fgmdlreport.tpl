             ...
             <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $geos['Fgm_date']; ?></td>
                   <td class="text-left"><?php echo $geos['VILLAGE_NAME']; ?></td>
                    <td class="text-left"><?php echo $geos['Farmer_count']; ?></td>
...
<script type="text/javascript">
 ...
 $('#searchbtn').on('click', function() {
    ...
    url = 'index.php?route=Report/fgmdlreport&token='+getURLVar('token');
...
$('#downloadattendance').on('click', function() {
   ...
   url = 'index.php?route=Report/fgmdlreport/marketpos_download&token='+getURLVar('token');
    var filter_fdate_id = $('input[name=\'from_date\']').val();
    var filter_tdate_id = $('input[name=\'to_date\']').val();
    var filter_market_pos = $('#market_pos').val();
...
function CheckIsCharacter(e,t){
       ...
       function getmdo(state_id){
        ...
        $.ajax({ 
        type: 'post',
        url: 'index.php?route=Report/fgmdlreport/getmdo&token='+getURLVar('token'),
        data: 'state='+state_id,
        // dataType: 'json',
        cache: false,
