            ...
            <div class="row">
              ...
              <select name="act" id="act" class="form-control">
                  ...
                  <?php foreach($activity as $value) { ?>
                   <option value="<?php echo $value['SID']; ?>" <?php if($lastact==$value['SID']) { echo 'selected'; } ?>><?php echo $value['USER_ACTIVITY']; ?></option>
                  <?php } ?>
              </select>    
              <p id="Group_Name_p" style="display:none;color:red;">Required customer group Name</p>
              </div>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'o.order_id') { ?>
                    <a href="<?php echo $sort_order; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_district; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_order; ?>"><?php echo $column_district; ?></a>
                    <?php } ?></td>
                  ...
                  <td class="text-right"><?php if ($sort == 'o.total') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'o.total') { ?>
                    <a href="<?php echo $sort_total; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_remarks; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_total; ?>"><?php echo $column_remarks; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php echo $geos['State']; ?></td>
                  <td class="text-left"><?php echo $geos['MARKET']; ?></td>
                  <td class="text-left"><?php echo $geos['Mdo_Name']; ?></td>
                   <td class="text-left"><?php echo $geos['CR_Date']; ?></td>
                    <td class="text-left"><?php echo $geos['ACT']; ?></td>
                  <td class="text-right"><?php echo $geos['Remarks']; ?></td>
