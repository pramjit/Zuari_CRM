        ...
        <ul id="geo" class="nav nav-tabs nav-justified">
          ...
          <div class="tab-content">   
            ...
            <div class="form-group required">
              <label class="col-sm-2 control-label" >Nation Name</label>
              <div class="col-sm-4">
                  ...
                  <p style="display:none;color:red;">Required nation name</p>
              </div>
            </div>
            
              <div class="buttons">
                <div class="pull-right">
                    <input type="submit" value="Create nation" id="button-nation" class="btn btn-primary" />
                </div>
              </div>
              ...
              <select name="select_state_nation" onchange="clear_State_Nation()" id="select_state_nation" class="form-control">
                ...
                <?php } ?>
                 ...
                 <p id="nation_state_p" style="display:none;color:red;">Required select nation</p>
               </div>
              </div>  
            ...
            <div class="form-group required">
             ...
             <div class="form-group required">
                <label class="col-sm-2 control-label" >Head Quater</label>
                <div class="col-sm-4">
                  <input  id="hq_name" onkeyup="clear_hq_name()" onkeypress="return CheckIsCharacter(event,this);" class="form-control" type="text" name="hq_name"  placeholder="Enter Head Quater name"/>
              ...
              <div class="buttons">
                <div class="pull-right">
                  <input type="submit" value="Create HQ" id="button-area" class="btn btn-primary" />
                </div>
              </div>
              </div>
