...
function updateretailerreg(customerid){
    url = 'index.php?route=retailer/retailerregistration&customeridupdate='+customerid+'&token='+getURLVar('token');
    location = url;
}
// download
...
function download(){
     url = 'index.php?route=retailer/viewretailerreg/retailer_download&token='+getURLVar('token');
    location = url; 
}
