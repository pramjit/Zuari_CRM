           ...
           <div class="row">
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input id="input_status" onkeypress="return CheckIsCharacter(event,this);" name="input_status" class="form-control" type="text" placeholder="Search Crop"/>
              </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'customer') { ?>
                    <a href="<?php echo $sort_customer; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_crop_name; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_customer; ?>"><?php echo $column_crop_name; ?></a>
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'status') { ?>
                    <a href="<?php echo $sort_status; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_season_name; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_status; ?>"><?php echo $column_season_name; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($crops['SID'], $selected)) { ?>
                  ...
                  <td class="text-right"><?php echo $crops['SID']; ?></td>
                  <td class="text-left"><?php echo $crops['NAME']; ?></td>
                  <td class="text-left"><?php echo $crops['SNAME']; ?></td>
                  <td class="text-right"><?php echo $crops['ACT']; ?></td>
