 ...
 * @author agent
 */
class ControllerCropsearchcrop extends Controller {
    public function  index(){
        
        $this->load->language('crop/searchcrop');

	$this->document->setTitle($this->language->get('heading_title'));
      
       
	$this->load->model('crop/searchcrop');
    ...
    protected function getList() {
        ...
        $order_total = $this->model_crop_searchcrop->getTotalCrop($filter_data);

        $results = $this->model_crop_searchcrop->getCrop($filter_data);
        ...
        $data['column_crop_name'] = $this->language->get('column_crop_name');
        $data['column_season_name'] = $this->language->get('column_season_name');
	...
	$this->load->model('crop/searchcrop');
        ...
        $data['entry_status'] = $this->language->get('Search Crop Name');
  ...
  $data['searchcrop'] = $this->url->link('crop/searchcrop', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('crop/searchcrop', 'token=' . $this->session->data['token'], 'SSL')
		);
      ...
      $this->response->setOutput($this->load->view('crop/searchcrop.tpl', $data));
