...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		if (!isset($this->request->get['token']) || !isset($this->session->data['token']) && ($this->request->get['token'] != $this->session->data['token'])) {
			...
			// Processing Orders
			$data['order_status_total'] = "0";//$this->model_sale_order->getTotalOrders(array('filter_order_status' => implode(',', $this->config->get('config_processing_status'))));
			...
			// Complete Orders
			$data['complete_status_total'] = "0";//$this->model_sale_order->getTotalOrders(array('filter_order_status' => implode(',', $this->config->get('config_complete_status'))));
			...
			$data['return_total'] ="0";// $return_total;
			...
			$data['online_total'] = "0";//$this->model_report_customer->getTotalCustomersOnline();
			...
			$data['customer_total'] = "0";//$customer_total;
			...
			$data['product_total'] = "0";//$product_total;
			...
			$data['review_total'] = "0";//$review_total;
			...
			$data['affiliate_total'] = "0";//$affiliate_total;
			$data['affiliate_approval'] ="#";// $this->url->link('marketing/affiliate', 'token=' . $this->session->data['token'] . '&filter_approved=1', 'SSL');

			$data['alerts'] ="0";// $customer_total + $product_total + $review_total + $return_total + $affiliate_total;
