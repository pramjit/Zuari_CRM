...
class ControllerProductsearchproduct extends Controller {
    public function  index(){
        ...
        $this->load->language('product/searchproduct');

	$this->document->setTitle($this->language->get('heading_title'));
      
       
	$this->load->model('product/searchproduct');
    ...
    protected function getList() {
        ...
        $order_total = $this->model_product_searchproduct->getTotalProduct($filter_data);

        $results = $this->model_product_searchproduct->getProduct($filter_data);
        ...
        $data['column_village_name'] = $this->language->get('column_village_name');
        ...
        $data['column_product_group'] = $this->language->get('column_product_group');
        ...
        $data['token'] = $this->session->data['token'];
         $this->load->language('village/searchvillage');
	...
	$this->load->model('product/searchproduct');
        ...
        $data['entry_status'] = $this->language->get('Search Product Name');
      ...
      //  $this->load->model('localisation/order_status');
        ...
        $data['sort'] = $sort;
        $data['order'] = $order;
  $data['searchproduct'] = $this->url->link('village/searchproduct', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('village/searchproduct', 'token=' . $this->session->data['token'], 'SSL')
		);
      ...
      $this->response->setOutput($this->load->view('product/searchproduct.tpl', $data));
