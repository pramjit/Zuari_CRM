 ...
 * @author agent
 */
class Controllerfarmerviewfarmer extends Controller {
    public function  index(){
        
        $this->load->language('farmer/viewfarmer');
    ...
    protected function getList() {
       ...
       if (isset($this->request->get['filter_state_id'])) {
        ...
        $data['lnk'] = $this->url->link('farmer/farmerregistration', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['retailerdata']= $this->model_farmer_farmerregistration->getretailerregdata();
        $order_total_count = $this->model_farmer_farmerregistration->getretailerregdata();
	...
	//$this->load->model('retailer/createretailer');
        ...
        $pagination->url = $this->url->link('farmer/viewfarmer', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
      ...
      //  $this->load->model('localisation/order_status');
		...
		$data['breadcrumbs'][] = array(
			'text' => 'View Retailer',
			'href' => $this->url->link('farmer/viewfarmer', 'token=' . $this->session->data['token'], 'SSL')
		);
      ...
      $this->response->setOutput($this->load->view('farmer/viewfarmer.tpl', $data));
