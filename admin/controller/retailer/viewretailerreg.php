 ...
 * @author agent
 */
class Controllerretailerviewretailerreg extends Controller {
    public function  index(){
        
        $this->load->language('retailer/viewretailerreg');
    ...
    protected function getList() {
       ...
       if (isset($this->request->get['filter_state_id'])) {
        ...
        $data['retailerdata']= $this->model_retailer_retailerregistration->getretailerregdata();
        $order_total_count = $this->model_retailer_retailerregistration->getretailerregdata();
	...
	$this->document->setTitle($this->language->get('View Retailer'));
	...
	//$this->load->model('retailer/createretailer');
        ...
        $pagination->url = $this->url->link('retailer/viewretailer', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
      ...
      //  $this->load->model('localisation/order_status');
		...
		$data['breadcrumbs'][] = array(
			'text' => 'View Retailer',
			'href' => $this->url->link('retailer/viewretailerreg', 'token=' . $this->session->data['token'], 'SSL')
		);
      ...
      $this->response->setOutput($this->load->view('retailer/viewretailerreg.tpl', $data));
    ...
    public function retailer_download(){
    ...
    $this->load->model('retailer/retailerregistration');
    $results = $this->model_retailer_retailerregistration->getretailerregdata();
