 ...
 * @author agent
 */
class Controllerretailerviewretailer extends Controller {
    public function  index(){
        
        $this->load->language('retailer/viewretailer');
    ...
    protected function getList() {
       ...
       if (isset($this->request->get['filter_state_id'])) {
        ...
        $data['lnk'] = $this->url->link('retailer/createretailer', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['retailerdata']= $this->model_retailer_createretailer->getretailerdata($filter_data);
        $order_total_count = $this->model_retailer_createretailer->getretailerdatacount($filter_data);
	...
	$this->load->model('retailer/createretailer');
      ...
      //  $this->load->model('localisation/order_status');
		...
		$data['breadcrumbs'][] = array(
			'text' => 'View Retailer',
			'href' => $this->url->link('retailer/viewretailer', 'token=' . $this->session->data['token'], 'SSL')
		);
      ...
      $this->response->setOutput($this->load->view('retailer/viewretailer.tpl', $data));
